...
# Mock Data: **The data/ directory stores mock input datasets and ground truth for evaluation. **Generated outputs, including tickets and logs, are written to outputs/. 
Dependencies and environment configuration are managed via requirements.txt and .env.
